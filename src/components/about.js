    ...
    return <div className="block about" id="AboutBlock">
      ...
      <div className="aboutMiniText max1024">
        <div className="aboutDataBlock imageAbout" id="imageAbout">
          <Fade delay={50}><img id="oneImageAbout" src={this.props.myLocation + this.props.data.bg2} alt=""/></Fade>
          <Fade delay={75}><img id="twoImageAbout" data-depth="0.1" src={ this.props.myLocation + this.props.data.bg1} alt=""/></Fade>
        </div>
      ...
      <div className="aboutFooterSvg" id="aboutFooterSvg" style={{"height":(this.props.data.writeOnline)?540:175+"px"}}>
        <div id="onlineWritingBlock" className={(this.props.data.writeOnline)?"blockFeedBack show":"blockFeedBack"}>
          ...
          <div className="defaultButton mobileSetBtn">Записатись</div>
        </div>
