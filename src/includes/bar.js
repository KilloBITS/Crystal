  ...
  render() {
    return <div className="navBar" id="navBar">
      ...
      <div className={this.state.visibleBTN?"feedBackAbsoluteBtn":"feedBackAbsoluteBtn hide"} onClick={this.toClickFeedBack.bind(this)} id="feedBackAbsoluteBtn">
        ...
        <a href={this.props.dataAbout.insta} rel="noopener noreferrer"><div className={this.state.clickedFeedback?"chilsFeedBackBtn insta openFeed":"chilsFeedBackBtn insta"}><FontAwesomeIcon icon={['fab', 'instagram']} /></div></a>
        ...
        <a href={this.props.dataAbout.facebook} rel="noopener noreferrer"><div className={this.state.clickedFeedback?"chilsFeedBackBtn facebook openFeed":"chilsFeedBackBtn facebook"}><FontAwesomeIcon icon={['fab', 'facebook']} /></div></a>
      </div>
